...
id: 'INT-0003'
type: 'intervention'
name: 'Methyl-B12 (methylcobalamin) injection'
category: 'supplement'
modality: 'supplement'
directionality: 'treatment'
csrs_score: 48.07
csrs_prevention_score: 60.18
csrs_treatment_score: 49.64
status: 'active'
otc_or_rx: 'rx'
pediatric_safe: 'yes'
cost_per_month_usd: 50
dose_range: '75 µg/kg every 3 days, SC'
...
Provides active form of B12 to support methylation; subcutaneous injection bypasses GI absorption issues common in autism.


**Dose range:** 75 µg/kg every 3 days, SC


**Cost per month (USD):** 50


**Notes / warnings:** Hendren 2016 RCT
